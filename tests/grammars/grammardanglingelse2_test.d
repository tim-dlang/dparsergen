...
unittest
{
    import P = grammardanglingelse2;

    alias L = imported!"grammardanglingelse2_lexer".Lexer!LocationBytes;
    ...
    test("if()if()s;else s;", q{S(IfStmt("if", "(", ")", IfStmt("if", "(", ")", Stmt("s", ";"), "else", Stmt("s", ";"))))});
